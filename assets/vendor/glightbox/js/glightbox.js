  ...
  var GlightboxInit = function () {
    ...
    _createClass(GlightboxInit, [{
      ...
      value: function open() {
        ...
        if (isNode(element)) {
          var memes = element.getAttribute('data-memes');

          if (memes) {
            this.fullElementsList = this.elements;
            this.elements = this.getmemesElements(this.elements, memes);
          }
      ...
      value: function getElements() {
        ...
        each(nodes, function (el, i) {
          ...
          slideInfo.instance = slide;
          slideInfo.slideConfig = elData;
          slideInfo.memes = el.getAttribute('data-memes');
          list.push(slideInfo);
        });
      ...
      key: "getmemesElements",
      value: function getmemesElements(list, memes) {
        return list.filter(function (el) {
          return el.memes == memes;
        });
      }
    }, {
      key: "getSelector",
